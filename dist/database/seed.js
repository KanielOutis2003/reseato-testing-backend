...
const seed = async () => {
    ...
    try {
        ...
        for (const user of baseUsers) {
            await client.query(`INSERT INTO users (email, password_hash, first_name, last_name, role, phone)
         VALUES ($1, $2, $3, $4, $5, $6)`, [user.email, user.password, user.firstName, user.lastName, user.role, user.phone]);
        ...
        RETURNING *`, [
         ...
         VALUES ($1, $2, $3)`, [restaurant.id, rData.image, true]);
            ...
            for (const table of tables) {
                await client.query(`INSERT INTO tables (restaurant_id, table_number, capacity, is_available)
           VALUES ($1, $2, $3, $4)`, [restaurant.id, table.number, table.capacity, table.is_available]);
            }
        }
